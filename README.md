...
![과목: OneChip Physical Design](https://img.shields.io/badge/과목-OneChip%20Physical%20Design-4CAF50?style=flat&logo=databricks&logoColor=white)

---
## 💻 기술 스택 (Tech Stack)

### 📕 언어 (Languages)
![Shell Script](https://img.shields.io/badge/Shell-Scripting-FCC624?style=flat&logo=gnu-bash&logoColor=black)

---

### 🔧 툴 (Tools)
![Synopsys Custom Compiler](https://img.shields.io/badge/Synopsys-Custom%20Compiler-663399?style=flat&logoColor=white)
...
- 과정: AI 시스템반도체설계 2기  
- 과목: OneChip Physical Design

---

### 📌 프로젝트 정보 (Project Info)
- **프로젝트 주제**: Synopsys Full-Custom IC Design
- **진행 기간**: 25.10.01 ~ 25.10.28
- **구성원**: 최지우  
---------------------------------------------------
- **Project Title**: Synopsys Full-Custom IC Design
- **Duration**: 25.10.01 ~ 25.10.28
- **Members**: Choi Jiwoo
